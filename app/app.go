...
func (app *TokenFactoryApp) setPostHandler() {
...
func (app *TokenFactoryApp) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker application updates every end block
func (app *TokenFactoryApp) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

func (app *TokenFactoryApp) Configurator() module.Configurator {
	return app.configurator
}

// InitChainer application update at chain initialization
func (app *TokenFactoryApp) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *TokenFactoryApp) LoadHeight(height int64) error {
...
func (app *TokenFactoryApp) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *TokenFactoryApp) AutoCliOpts() autocli.AppOptions {
...
func (app *TokenFactoryApp) DefaultGenesis() map[string]json.RawMessage {
...
func (app *TokenFactoryApp) GetStoreKeys() []storetypes.StoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *TokenFactoryApp) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *TokenFactoryApp) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
func (app *TokenFactoryApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *TokenFactoryApp) RegisterTendermintService(clientCtx client.Context) {
